...
*/
Vue.component("simple_hero_component_1722500716", {
    template: `
        <section id="hero-section" class="bg-gradient-to-br from-pink-500 to-purple-600 flex-1 min-h-screen flex items-center justify-center">
            <div id="hero-container" class="grid max-w-screen-xl px-8 py-12 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 backdrop-blur-lg bg-white/10 rounded-3xl shadow-2xl">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-pink-100 lg:mb-8 md:text-lg lg:text-xl">Our cutting-edge analytics platform harnesses blockchain data</p>
                    </div>
